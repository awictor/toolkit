...
check('exactly 7 tool cards', () => {
  assert.equal((html.match(/class="card"/g) || []).length, 7);
});
check('valid JSON-LD ItemList with 7 items', () => {
